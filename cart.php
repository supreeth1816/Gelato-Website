...
<?php
  ...
  </a>&nbsp;<a href="foodlist.php"></a>&nbsp;<a href="COD.php"><button class="btn btn-success pull-right"> Check Out</button></a>';
?>
</div>
...
if(empty($_SESSION["cart"]))
{
  ...
  <div class="container">
      <div class="jumbotron">
        <h1>Your Shopping Cart</h1>
        <p> Empty! Go back and <a href="foodlist.php">order now.</a></p>
